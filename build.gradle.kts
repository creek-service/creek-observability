...
subprojects {
    ...
    extra.apply {
        ...
        set("spotBugsVersion", "4.9.2")         // https://mvnrepository.com/artifact/com.github.spotbugs/spotbugs-annotations
        ...
        set("jacksonVersion", "2.18.3")         // https://mvnrepository.com/artifact/com.fasterxml.jackson.core/jackson-databind
